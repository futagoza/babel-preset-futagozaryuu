...
function buildOptions( config = {} ) {
    ...
    else if ( typeof browserslist === "string" )

        envOptions.configPath = browserslist;

    else if ( typeof browserslist === "object" ) {
    ...
    if ( typeof config.node === "string" && ! config.node.includes( "current" ) )
